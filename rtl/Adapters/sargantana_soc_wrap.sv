...
#(
  ...
  // FIXED: Changed default from 'logic' to actual struct types so Vivado doesn't crash
  ...
  sargantana_hpdcache_axi_wrap #(
    .AXI_DATA_WIDTH        ( AxiDataWidth          ),
    // FIXED: Mapped types correctly for Synthesis
  ...
  assign axi_mst_ar_len_o    = mux_req.ar.len;
  assign axi_mst_ar_size_o   = mux_req.ar.size;
  assign axi_mst_ar_burst_o  = mux_req.ar.burst;
  assign axi_mst_ar_lock_o   = mux_req.ar.lock;
  assign axi_mst_ar_cache_o  = mux_req.ar.cache;
  assign axi_mst_ar_prot_o   = mux_req.ar.prot;
  assign axi_mst_ar_qos_o    = mux_req.ar.qos;
  assign axi_mst_ar_region_o = mux_req.ar.region;
  assign axi_mst_ar_user_o   = mux_req.ar.user;
  assign mux_resp.ar_ready   = axi_mst_ar_ready_i;

  assign mux_resp.r_valid    = axi_mst_r_valid_i;
  assign mux_resp.r.data     = axi_mst_r_data_i;
  assign mux_resp.r.id       = axi_mst_r_id_i;
  assign mux_resp.r.last     = axi_mst_r_last_i;
  assign mux_resp.r.resp     = axi_mst_r_resp_i;
  assign mux_resp.r.user     = axi_mst_r_user_i;
  assign axi_mst_r_ready_o   = mux_req.r_ready;

  assign axi_mst_aw_valid_o  = mux_req.aw_valid;
  assign axi_mst_aw_addr_o   = mux_req.aw.addr;
  assign axi_mst_aw_id_o     = mux_req.aw.id;
  assign axi_mst_aw_len_o    = mux_req.aw.len;
  assign axi_mst_aw_size_o   = mux_req.aw.size;
  assign axi_mst_aw_burst_o  = mux_req.aw.burst;
  assign axi_mst_aw_lock_o   = mux_req.aw.lock;
  assign axi_mst_aw_cache_o  = mux_req.aw.cache;
  assign axi_mst_aw_prot_o   = mux_req.aw.prot;
  assign axi_mst_aw_qos_o    = mux_req.aw.qos;
  assign axi_mst_aw_region_o = mux_req.aw.region;
  assign axi_mst_aw_user_o   = mux_req.aw.user;
  assign axi_mst_aw_atop_o   = mux_req.aw.atop;
  assign mux_resp.aw_ready   = axi_mst_aw_ready_i;

  assign axi_mst_w_valid_o   = mux_req.w_valid;
  assign axi_mst_w_data_o    = mux_req.w.data;
  assign axi_mst_w_strb_o    = mux_req.w.strb;
  assign axi_mst_w_last_o    = mux_req.w.last;
  assign axi_mst_w_user_o    = mux_req.w.user;
  assign mux_resp.w_ready    = axi_mst_w_ready_i;

  assign mux_resp.b_valid    = axi_mst_b_valid_i;
  assign mux_resp.b.id       = axi_mst_b_id_i;
  assign mux_resp.b.resp     = axi_mst_b_resp_i;
  assign mux_resp.b.user     = axi_mst_b_user_i;
  assign axi_mst_b_ready_o   = mux_req.b_ready;
