...
& \verb$<hpdcache_instance>.hpdcache_miss_handler_sarg_i.hpdcache_mshr_sarg_i.mshr_sram$ \\
\midrule
\textbf{Details}
...
\midrule
\textbf{\acs{RTL} Instance}
& \verb$<hpdcache_instance>.hpdcache_ctrl_sarg_i.hpdcache_memctrl_sarg_i.hpdcache_memarray_i.dir_sram[i]$ \\
\midrule
\textbf{Details}
...
\midrule
\textbf{\acs{RTL} Instance}
& \verb$<hpdcache_instance>.hpdcache_ctrl_sarg_i.hpdcache_memctrl_sarg_i.hpdcache_memarray_i.data_sram[i]$ \\
\midrule
\textbf{Details}
& \Secref{dir_data_ram_implementation} \\
\midrule
