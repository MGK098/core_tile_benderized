...
(
    ...
    output hpdcache_cmo_sargh_op_t     cmo_req_op_o,
    ...
    hpdcache_rtab_sarg_deps_t     st1_rtab_deps;
    ...
    //  {{{
    hpdcache_ctrl_sarg_pe_sarg #(
        .HPDcacheCfg(HPDcacheCfg)
    ) hpdcache_ctrl_sarg_pe_sarg_i(
        .core_req_valid_i,
        .core_req_ready_o,
