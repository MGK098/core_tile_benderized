...
(
    ...
    //  Internal components
    //  {{{
    hpdcache_decoder_sarg #(.N(FlushIndexWidth)) flush_ack_decoder_i(
        .en_i           (flush_ack),
    ...
    //
    hpdcache_fxarb_sarg #(.N(FlushEntries)) flush_dir_free_arb_i(
        .clk_i,
        .rst_ni,
    ...
    hpdcache_1hot_to_binary_sarg #(.N (FlushEntries)) flush_dir_free_ptr_bin_i(
