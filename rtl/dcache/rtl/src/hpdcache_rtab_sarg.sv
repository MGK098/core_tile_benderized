...
(
    ...
    input  hpdcache_rtab_sarg_deps_t   alloc_deps_i,
...
//  {{{
    ...
    hpdcache_rtab_sarg_deps_t[N-1:0]  deps_q;
    hpdcache_rtab_sarg_deps_t[N-1:0]  deps_set, deps_rst;
    hpdcache_rtab_sarg_deps_t[N-1:0]  alloc_deps_set;
    hpdcache_rtab_sarg_deps_t[N-1:0]  pop_rback_deps_set;
...
//  {{{
    ...
    hpdcache_prio_1hot_encoder_sarg #(
        .N         (N)
    ) free_encoder_i (
        .val_i     (free),
        .val_o     (free_alloc)
