...
`endif
    ...
    logic                  cmo_req_valid;
    logic                  cmo_ready;
    hpdcache_cmo_sargh_op_t     cmo_req_op;
    ...
    hpdcache_mem_req_read_arbiter_sarg #(
        .N                     (2),
        .hpdcache_mem_req_t    (hpdcache_mem_req_t)
    ) hpdcache_mem_req_read_arbiter_sarg_i(
        .clk_i,
        .rst_ni,
...
`endif
    ...
    hpdcache_mem_req_write_arbiter_sarg #(
        .N                             (3),
        .hpdcache_mem_req_t            (hpdcache_mem_req_t),
        .hpdcache_mem_req_w_t          (hpdcache_mem_req_w_t)
    ) hpdcache_mem_req_write_arbiter_sarg_i (
        .clk_i,
        .rst_ni,
