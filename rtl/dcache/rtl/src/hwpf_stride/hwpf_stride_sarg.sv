...
(
    ...
    input  hwpf_stride_sarg_base_t           csr_base_i,
    input  logic                        csr_param_set_i,
    input  hwpf_stride_sarg_param_t          csr_param_i,
    input  logic                        csr_throttle_set_i,
    input  hwpf_stride_sarg_throttle_t       csr_throttle_i,

    output hwpf_stride_sarg_base_t           csr_base_o,
    output hwpf_stride_sarg_param_t          csr_param_o,
    output hwpf_stride_sarg_throttle_t       csr_throttle_o,
...
//  }}}
    ...
    typedef enum {
        ...
        DONE,
        ABORT
    } hwpf_stride_sarg_fsm_t;

    hwpf_stride_sarg_fsm_t state_d, state_q;
    ...
    hwpf_stride_sarg_base_t csr_base_q;
    hwpf_stride_sarg_base_t shadow_base_q, shadow_base_d;
    hwpf_stride_sarg_param_t csr_param_q;
    hwpf_stride_sarg_param_t shadow_param_q, shadow_param_d;
    hwpf_stride_sarg_throttle_t csr_throttle_q;
    hwpf_stride_sarg_throttle_t shadow_throttle_q, shadow_throttle_d;
