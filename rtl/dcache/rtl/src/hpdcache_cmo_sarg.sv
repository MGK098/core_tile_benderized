...
(
    ...
    input  hpdcache_cmo_sargh_op_t     req_op_i,
...
//  {{{
    ...
    } hpdcache_cmo_sargh_fsm_t;
//  }}}

//  Internal signals and registers
//  {{{
    hpdcache_cmo_sargh_fsm_t   cmoh_fsm_q, cmoh_fsm_d;
    hpdcache_cmo_sargh_op_t    cmoh_op_q, cmoh_op_d;
