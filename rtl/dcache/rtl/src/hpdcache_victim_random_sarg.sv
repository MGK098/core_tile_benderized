 ...
 *  History       :
 */
module hpdcache_victim_random_sarg
...
(
    ...
    hpdcache_decoder_sarg #(.N(HPDcacheCfg.wayIndexWidth))
        rand_way_decoder_i(
            .en_i      (1'b1),
    ...
    hpdcache_prio_1hot_encoder_sarg #(.N(HPDcacheCfg.u.ways))
