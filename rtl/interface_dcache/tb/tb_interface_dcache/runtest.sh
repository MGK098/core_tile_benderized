...
vlog $VLOG_FLAGS +acc=rn +incdir+ ${TOP_DIR}/includes/riscv_pkg_sarg.sv ${TOP_DIR}/includes/drac_pkg.sv ${TOP_DIR}/rtl/interface_dcache/rtl/dcache_interface.sv tb_module.sv colors.vh
