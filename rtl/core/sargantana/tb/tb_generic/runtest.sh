...
vlog $VLOG_FLAGS +acc=rn +incdir+ ${TOP_DIR}hdl/riscv_pkg_sarg.sv ${TOP_DIR}hdl/drac_pkg.sv ${TOP_DIR}hdl/datapath/exe_stage/hdl/mem_unit.sv tb_module.sv colors.vh
