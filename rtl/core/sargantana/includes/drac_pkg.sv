...
`ifndef CONF_SARGANTANA_PHY_ADDR_SIZE
    `define CONF_SARGANTANA_PHY_ADDR_SIZE 48 //32
`endif
...
localparam drac_cfg_t DracDefaultConfig = '{
    ...
    InitIOBase:  {48'h40000000}, // IO base 0 address after reset
    InitIOEnd:  {48'h80000000}, // IO end 0 address after reset

    NMappedSections: 3, // number of Memory space sections
    InitMappedBase: {48'h0040000000, 48'h0000000100, 48'h0000010000}, // Memory base address after reset
    InitMappedEnd: {48'h3fffffffff, 48'h000000ffff, 48'h0000010020}, // Memory end 0 address after reset

    InitBROMBase: 48'h0000000100,
    InitBROMEnd: 48'h000000ffff,

    DebugProgramBufferBase: 48'h0000010000,
    DebugProgramBufferEnd:  48'h0000010020,
