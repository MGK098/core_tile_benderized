...
module fpnew_divsqrt_th_32_sarg #(
  // FP32-only DivSqrt
  // FPU configuration
  ...
  assign div_op   = in_valid_q & (op_q == fpnew_pkg_sarg::DIV) & in_ready & ~flush_i;  //in_ready delete, valid independent of ready
  assign sqrt_op  = in_valid_q & (op_q == fpnew_pkg_sarg::SQRT) & in_ready & ~flush_i;
