...
// Design Name:    FPU                                                        //
// Module Name:    div_sqrt_mvp_wrapper_sarg.sv                                    //
// Project Name:   The shared divisor and square root                         //
// Language:       SystemVerilog                                              //
//                                                                            //
// Description:    The wrapper of  div_sqrt_top_mvp_sarg                           //
//                                                                            //
//                                                                            //
//                                                                            //
//                                                                            //
...
module div_sqrt_mvp_wrapper_sarg
#(
  ...
  generate
    if(PrePipeline_depth_S==1)
      begin
         ...
         div_sqrt_top_mvp_sarg  div_top_U0  //for RTL
