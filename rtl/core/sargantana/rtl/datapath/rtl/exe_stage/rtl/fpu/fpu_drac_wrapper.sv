...
logic ready_fpu;
fpnew_pkg_sarg::status_t result_fp_status_int,finish_fp_status_int;
...
always_comb begin
   ...
   case (instruction_i.instr.instr_type)
      ...
      drac_pkg::FMIN_MAX: begin 
         op          = fpnew_pkg_sarg::MINMAX;
         op_mod      = 0;
      end 
      drac_pkg::FCMP: begin
         op          = fpnew_pkg_sarg::CMP;
         op_mod      = 0;
      end
      drac_pkg::FCLASS: begin
         op          = fpnew_pkg_sarg::CLASSIFY;
         op_mod      = 0;
      end   
      drac_pkg::FSGNJ: begin
         op          = fpnew_pkg_sarg::SGNJ;
         op_mod      = 0;
      end
      // FCVT_F2I, FCVT_I2F, FCVT_F2F, FSGNJ, FMV_F2X, FMV_X2F,
      // FP to I
      drac_pkg::FCVT_F2I: begin
         op          = fpnew_pkg_sarg::F2I;
      ...
      drac_pkg::FCVT_I2F: begin
         op          = fpnew_pkg_sarg::I2F;
         op_mod      = instruction_i.instr.rs2[0]; // 1 --> Unsigned
         int_fmt     = instruction_i.instr.rs2[1] ? INT64 : INT32;
      end
      // FP to FP
      drac_pkg::FCVT_F2F: begin
         op              = fpnew_pkg_sarg::F2F;
         op_mod          = 0;
      ...
      drac_pkg::FMV_X2F: begin
         ...
         op_mod          = 1;
         rnd_mode_sel    = 1'b1;
         opcode_rnd_mode = fpnew_pkg_sarg::RUP;
      end
      default: begin 
...
fpnew_pkg_sarg::roundmode_e rnd_mode;
assign rnd_mode = rnd_mode_sel ? fpnew_pkg_sarg::roundmode_e'(W3_logic'(opcode_rnd_mode))
                               : fpnew_pkg_sarg::roundmode_e'(W3_logic'(instruction_i.instr.frm));
...
fpnew_top_sarg #(
   ...
   .operands_i     ( operands ),
   .rnd_mode_i     ( rnd_mode ),
   .op_i           ( fpnew_pkg_sarg::operation_e'(W4_logic'(op ))),
   .op_mod_i       ( op_mod ),
   .src_fmt_i      ( fpnew_pkg_sarg::fp_format_e'(W3_logic'(src_fmt ))),
   .dst_fmt_i      ( fpnew_pkg_sarg::fp_format_e'(W3_logic'(dst_fmt ))),
   .int_fmt_i      ( fpnew_pkg_sarg::int_format_e'(W2_logic'(int_fmt ))),
   .simd_mask_i    ( '0 ),
