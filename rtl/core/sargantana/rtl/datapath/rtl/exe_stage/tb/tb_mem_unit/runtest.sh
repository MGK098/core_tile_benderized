...
vlog +acc=rn +incdir+ ${BASE_DIR}/includes/riscv_pkg_sarg.sv ${BASE_DIR}/includes/drac_pkg.sv ${BASE_DIR}/rtl/interface_dcache/rtl/interface_dcache.sv ../../rtl/load_store_queue.sv ../../rtl/wip_mem_unit_lsq.sv tb_mem_unit.sv colors.vh
